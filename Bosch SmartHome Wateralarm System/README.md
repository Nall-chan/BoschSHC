...
# Bosch SmartHome Wasseralarm-System <!-- omit in toc -->
Auslesen und steuern derWasseralarm-Systems  
...
## 4. Einrichten der Instanzen in IP-Symcon
 ...
 Unter 'Instanz hinzufügen' kann das 'Bosch SmartHome Wasseralarm-System'-Modul mithilfe des Schnellfilters gefunden werden.  
...
| ---------------------- | ------- | -------------------------- | ------------------------------ |
| WaterAlarmSystem_state | string  | BSH.WaterAlarmSystem.state | Zustand des Wasseralarmsystems |
| WaterAlarmSystem_mute  | integer | BSH.WaterAlarmSystem.mute  | Stumm stellen                  |
